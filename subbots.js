            ...
            async ({
                ...
                if (
                    ...
                    if (
                        ...
                        const attempts =
                            (RECONNECT_ATTEMPTS.get(jid) || 0) + 1

                        RECONNECT_ATTEMPTS.set(
                            jid,
                            attempts
                        )
                        ...
                        if (
                            ...
                            console.log(
                                `🛑 Subbot ${jid} superó el límite de reconexiones (${MAX_RECONNECT_ATTEMPTS}). Deteniendo intentos.`
                            )
                        ...
                        console.log(
                            `🔄 Reconectando subbot: ${jid} (intento ${attempts}/${MAX_RECONNECT_ATTEMPTS})`
                        )
