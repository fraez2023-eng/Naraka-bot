...
export function getSubbotConfig(botJid, defaultConfig) {
    ...
    try {
        ...
        if (cleanNumber && data[cleanNumber]) {
            ...
            return {
                name: subData.name || defaultConfig?.botName || config?.botName || '𝑵𝔸Ꮢ𝔸𝗞𝔸-𝗕ＯＴ',
                ownerName: subData.ownerName || defaultConfig?.ownerName || 'ϝяαєȥ',
        ...
        return {
            name: defaultConfig?.botName || config?.botName || '𝑵𝔸Ꮢ𝔸𝗞𝔸-𝗕ＯＴ',
            ownerName: defaultConfig?.ownerName || 'ϝяαєȥ',
